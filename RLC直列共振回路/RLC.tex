...
\begin{figure}[!h]
\center{
\includegraphics[clip, width=0.7\columnwidth]{img/f-I(2).eps}
\caption{周波数に対する電流特性}
\label{fig:f-I}
}
\end{figure}
...
\bibitem{ref:kyousin} TDK Techno Magazine \url{http://www.tdk.co.jp/techmag/inductive/200701/index2.htm}(参照2017-6-11).
\bibitem{ref:senneido} 堀浩雄(2015)「例題で学ぶやさしい電気回路[交流編]」p78 森北出版株式会社.
\end{thebibliography}
\end{document}